  ...
  <body>
    ...
    <section class="section">
        ...
        <div class="card-content">
            ...
            <div class="card">
            <p style="padding:20px">Você tenta de tudo para conseguir uma boa escola, talvez as suas escolhas no passado influenciarão nisso.</p>
            </div>
            </p>
        </div>
        <footer class="card-footer">
            ...
            <span>
            <a href="6_fase3dif.jsp">Continuar</a>
            </span>
            </p>
        </footer>
        </div>
