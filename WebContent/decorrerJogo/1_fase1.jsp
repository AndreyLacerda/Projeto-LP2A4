  ...
  <body>
    ...
    <section class="section">
        ...
        <div class="card-content">
            ...
            <div class="card">
            <p style="padding:20px"> Sua vida começa. Você veio de uma família rica e sua caminhada não será tão difícil. Seu pai é dono da maior empresa de Narguilés do mundo, e pode pagar tudo para você.</p>
            </div>
            </p>
        </div>
