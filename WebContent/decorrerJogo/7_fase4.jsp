  ...
  <body>
    ...
    <section class="hero" id="cabeca">
        ...
        <div class="container">
            ...
            <h2 class="subtitle" id="h2head">Vestibulares</h2>
        </div>
        </div>
    </section>
    ...
    <section class="section">
        ...
        <div class="card-content">
            ...
            <div class="card">
            <p style="padding:20px">Parabéns, você deu duro para o vestibular, o que vai proporcionar uma boa educação para o seu futuro.</p>
            </div>
            </p>
        </div>
