...
<html lang="pt-br" class="has-navbar-fixed-top">
  ...
  <body>
    ...
    <section class="hero" id="cabeca">
        <div class="hero-body">
        <div class="container">
            <h1 class="title" id="h1head">Transicionando</h1>
            <h2 class="subtitle" id="h2head">Voltando para a vida</h2>
        </div>
        </div>
    </section>
    ...
    <section class="section">
        ...
        <div class="card-content">
            ...
            <div class="card">
            <p style="padding:20px">Você socou a preguiça com o Maguila e conseguiu ganhar do Rui! Agora com o dinheiro que ganhou, está transicionando para outras fases do jogo!</p>
            </div>
            </p>
        </div>
