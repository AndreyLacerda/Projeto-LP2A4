  ...
  <body>
    ...
    <section class="hero" id="cabeca">
        ...
        <div class="container">
            ...
            <h2 class="subtitle" id="h2head">Vida escolar</h2>
        </div>
        </div>
    </section>
    ...
    <section class="section">
        ...
        <div class="card-content">
            ...
            <div class="card">
            <p style="padding:20px">Por seu pai ser um Anarguilheiro muito rico, você estudou sempre na melhor escola, e está prestes a terminar o ensino médio. Suas notas são boas e seu futuro já está semi pronto.</p>
            </div>
            </p>
        </div>
        <footer class="card-footer">
            ...
            <span>
            <a href="7_fase4.jsp">Continuar</a>
            </span>
            </p>
        </footer>
        </div>
