...
<%@ include file="../topo.jsp" %>
    ...
    <section class="hero" id="cabeca">
        <div class="hero-body">
        <div class="container">
            <h1 class="title" id="h1head">Fase 8</h1>
            <h2 class="subtitle" id="h2head">No bico do urubú</h2>
        </div>
        </div>
    </section>
    ...
    <section class="section">
        ...
        <div class="card-content">
            ...
            <div class="card">
            <p style="padding:20px">Você nega o convite para o kart e descobre de outro professor que caso aceitasse, seria sua morte. Com essa motivação, volta a estudar.</p>
            </div>
            </p>
        </div>
