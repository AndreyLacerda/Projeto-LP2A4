...
<html lang="pt-br" class="has-navbar-fixed-top">
  ...
  <body>
    ...
    <section class="hero" id="cabeca">
        <div class="hero-body">
        <div class="container">
            <h1 class="title" id="h1head">Fase 4</h1>
            <h2 class="subtitle" id="h2head">O rei do samba</h2>
        </div>
        </div>
    </section>
    ...
    <section class="section">
        ...
        <div class="card-content">
            ...
            <img style="padding-bottom:20px" src="../imagens/zeca.jpg"  width="500" height="500">
            <div class="card">
            <p style="padding:20px">Infelizmente seu rendimento na escola não é tão bom, então você desiste de estudar e vai pro bar. Chegando lá, você encontra a lenda Zeca Pagodinho, enquanto tem um sambão tocando no fundo.</p>
            </div>
            </p>
        </div>
